...
class TrueWallet {
	...
	public $device_id = "0426dd0724c80396"; // Set device_id here
	public $mobile_tracking = "CxBWTUQC4A0IGrZbBmC0FU6wCz5wDKUHbmuCEhELtnVkGMOTcCnjpQ=="; // Set mobile_tracking here
	...
	public function request ($api_path, $headers = array(), $data = null) {
		...
		if (!is_null($data)) {
			...
			if (is_array($data)) $headers = array_merge(array("Content-Type" => "application/json;charset=utf-8"), $headers);
		}
		curl_setopt_array($handle, array(
